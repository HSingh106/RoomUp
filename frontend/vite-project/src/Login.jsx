...
import image3 from './assets/image3 blur.jpg';
...
const LoginPage = () => {
    ...
    return (
        ...
        <div style={{
            backgroundColor: '#332569', backgroundImage: `url(${image3})`, 
            padding: "20px", display: "flex", overflow: "hidden", height: "100%", backgroundSize: "cover"
        }}>
